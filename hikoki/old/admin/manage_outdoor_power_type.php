...
<div class="container">
	<div class="row">
		<div class="page-header" style="margin: 0px;">
		  <h1>Outdoor Power Equipment Type <small>Add / Remove the outdoor power equipment type</small></h1>
		</div>
	</div>
	</br>
	<div class="row">
		<form name="addPowerToolsType" class="form-horizontal myform" action="manage_outdoor_power_type_action.php" method="POST" enctype="multipart/form-data" >
		...
		<form style="display: none;" class="deleteform" action="manage_outdoor_power_type_action.php" method="POST"  >
			<input type='hidden' name='action_type' value='addType' />
			<input type='hidden' name='id' value='' />
		</form>      

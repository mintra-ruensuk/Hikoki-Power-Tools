...
<?php
	...
	$types =  $a->getTypes();
  $powerToolsType = $_GET['power_tools_type'];
...
<div class="container">
	<div class="row">
		<div class="page-header" style="margin: 0px;">
		  <h1>Power Tools Type <small>จัดเรียงสินค้า</small></h1>
		</div>
	</div>
	</br>
	<div class="row">
		<form class="form-horizontal myform" action="manage_power_tools_orderlist_action.php" method="POST" enctype="multipart/form-data" >
      ...
      <div class="form-group">
          ...
          <textarea name="orderList" rows="10" cols="80">
            <?php
              if($orderListDataDB["order_list"] != null) {
...
<script>
  $("input:radio").change(function(e) {
      ...
      window.location.href = "http://"+window.location.hostname+window.location.pathname+"?power_tools_type=" + e.target.value ;
    });
</script>

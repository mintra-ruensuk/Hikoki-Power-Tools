...
<?php
	...
	if (isset($_GET['outdoor_power_equipment_type_id'])) {
		$productType = $a->getToolsTypeById($_GET['outdoor_power_equipment_type_id']);
		$productTypeEnName = $productType['type_name_en'];
		$orderListDataDB = $b->getOrdeListByTypeId($_GET['outdoor_power_equipment_type_id']);
	}else {
...
<div id="TopicPath">
	<ul>
		...
		<li>
			<a href="outdoor_power_equipment.php">Outdoor Power Equipment</a>
		</li>
	...
	<div class="GridSet">
		<div class="Grid3">
			<div class="PageTitleStyle1">
				<h1>
					<a name="body" id="body"><?php echo $productType['type_name_en']?></a>
				</h1>
			</div>
			...
			<div class="Section">
				<div class="main-content">
						<?php
							if (isset($_GET['outdoor_power_equipment_type_id'])) {
								$products = $a->getProductsByTypeId($_GET['outdoor_power_equipment_type_id']);
								...
								if (is_array($products) || is_object($products)){
									foreach ($products as $key=>$value) {
										...
										echo "<a href='outdoor_power_equipment_product.php?product_id=".$value["id"]."'><img src='".$value["user_image_dir"]."' /></a>";
										echo "</div>";
										echo "<div class=\"subCategory-content-wrapper\">";
										echo "<a href='outdoor_power_equipment_product.php?product_id=".$value["id"]."'><strong>".$value["product_name"]."</strong>";
										echo "</a>";
										if($value["is_new_product"]) {
											echo "<span class=\"new\"><img src='image/en/r1/icon/icon_new.gif' /></span>";
										}

										echo "<p class=\"TextStyle1\">".$value["short_description_en"]."</p>";

										echo "<ul class=\"LinkListStyle1\" style=\"margin-bottom: 0px;\">";
										echo "<li ><a href='outdoor_power_equipment_product.php?product_id=".$value["id"]."'>More</a>";
										echo "<ul><li>";
					...
					<?php
						...
						if (is_array($results) || is_object($results)){
							foreach ($results as $key=>$value) {
								...
								// }
								if($value["id"] == $_GET['outdoor_power_equipment_type_id']) {

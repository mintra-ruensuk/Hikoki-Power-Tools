		  ...
		  <div class="ResponsiveBrandingImgStyle">
				...
				<ul class="ColumnSet Panel">
						...
						<div class="Inner">
							...
							<div class="menu">
								<ul class="LinkListStyle1" style="padding-left: 15px;">
									<li><a href="power_tools.php">Products</a></li>
									<li><a href="power_tools.php#top">New Products</a></li>
					...
					<li class="Column1" >
						<div class="Inner">
								...
								<strong>Outdoor Power Equipment</strong>
							<div class="menu">
								<ul class="LinkListStyle1" style="padding-left: 15px;">
									<li><a href="outdoor_power_equipment.php">Products</a></li>
									<li><a href="outdoor_power_equipment.php#top">New Products</a></li>
									<li><a href="https://devs.hitachi-koki.co.jp/ois/login.html?te-uniquekey=1470f5b54a3">Technical Service & Support</a></li>
								</ul>
							</div>
						</div>
			...
			<div class="Section"> 
				...
				<ul class="LinkListStyle1"> 
					<li><a href="news.php">See all news </a></li>
				</ul>
				
			</div>

			<div class="Section">
				<h2><span>Products Catalog</span></h2>
			...
			<div class="Section">
				...
				<a href="JavaScript:WinOp();"><img src="image/index_below/battery_banner.jpg" width="100%" height="50%" alt="Important notice on the batteries for the Hitachi cordless power tools" border="0"></a>
				</li>
